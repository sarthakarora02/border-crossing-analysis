...
python3.7 ./src/border_analysis.py ./input/Border_Crossing_Entry_Data.csv # for small file
python3.7 ./src/border_analysis.py ./input/Border_Crossing_Entry_Data.csv # for large file 350k records
